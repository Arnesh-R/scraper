...
class Player2:
    ...
    def totalstats(self, params):
        ...
        other=""
        totalstat=process.playerdata2(self.playerid, params, other)
        return totalstat
    ...
    def innlist(self, params):
        ...
        process = data.Data(self.query)
        other="view=innings"
        inns = process.playerdata2(self.playerid, params, other)
        return inns
    ...
    def matchlist(self, params):
        ...
        other="view=matches"
        process = data.Data(self.query)
        matches = process.playerdata2(self.playerid, params, other)
        return matches
    ...
    def cavg(self, params):
        ...
        process = data.Data(self.query)
        cum = process.playerdata21(self.playerid, params, other, params, other)
        return cum
    ...
    def savg(self, params):
        ...
        other="view=series"
        process = data.Data(self.query)
        savg = process.playerdata2(self.playerid, params, other)
        return savg
    ...
    def gavg(self, params):
        ...
        other="view=ground"
        process = data.Data(self.query)
        gavg = process.playerdata2(self.playerid, params, other)
        return gavg
    ...
    def results(self, params):
        ...
        other="view=results"
        process = data.Data(self.query)
        results = process.playerdata2(self.playerid, params, other)
        return results
    ...
    def maw(self, params):
        ...
        process = data.Data(self.query)
        maw = process.playerdata2(self.playerid, params, other)
        return maw
    ...
    def saw(self, params):
        ...
        process = data.Data(self.query)
        saw = process.playerdata2(self.playerid, params, other)
        return saw
...
#Batting list    
    def pship_total(self, params):
        ...
        if self.query["type"]=="batting":
            process = data.Data(self.query)
            pships = process.playerdata2(self.playerid, params, other)
            return pships
        else:
    ...
    def dis_total(self, params):
        ...
        if self.query["type"]=="batting":
            process = data.Data(self.query)
            dis = process.playerdata2(self.playerid, params, other)
            return dis
        else:
            print("Available only for batting data")
    ...
    def bow_total(self, params):
        ...
        if self.query["type"]=="batting":
            process = data.Data(self.query)
            bt = process.playerdata2(self.playerid, params, other)
            return bt
        else:
            print("Available only for batting data")
    ...
    def fl_total(self, params):
        ...
        if self.query["type"]=="batting":
            process = data.Data(self.query)
            flt = process.playerdata2(self.playerid, params, other)
            return flt
        else:
            print("Available only for batting data")
    ...
    def dis_list(self, params):
        ...
        if self.query["type"]=="batting":
            process = data.Data(self.query)
            disl = process.playerdata2(self.playerid, params, other)
            return disl
        else:
            print("Available only for batting data")
...
#Bowling data
    def dis_sum(self, params):
        ...
        if self.query["type"]=="bowling":
            process = data.Data(self.query)
            dism = process.playerdata2(self.playerid, params, other)
            return dism
        else:
    ...
    def b_sum(self, params):
        ...
        if self.query["type"]=="bowling":
            process = data.Data(self.query)
            bats = process.playerdata2(self.playerid, params, other)
            return bats
        else:
            print("Available only for bowling data")
    ...
    def f_sum(self, params):
        ...
        if self.query["type"]=="bowling":
            process = data.Data(self.query)
            fsum = process.playerdata2(self.playerid, params, other)
            return fsum
        else:
            print("Available only for bowling data")
    ...
    def wlist(self, params):
        ...
        if self.query["type"]=="bowling":
            process = data.Data(self.query)
            dlist = process.playerdata2(self.playerid, params, other)
            return dlist
        else:
            print("Available only for bowling data")
